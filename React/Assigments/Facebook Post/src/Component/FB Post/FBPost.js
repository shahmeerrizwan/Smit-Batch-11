                    ...
                    <div className="col-md-6">
                        <div className="card">
                            <div className="d-flex justify-content-between p-2 px-3">
                                <div className="d-flex flex-row align-items-center"> <img src="https://i.imgur.com/UXdKE3o.jpg" width="50" className="rounded-circle" alt='...' />
                            ...
                            </div> <img src="https://i.imgur.com/xhzhaGA.jpg" className="img-fluid" alt='...' />
                            <div className="p-2">
